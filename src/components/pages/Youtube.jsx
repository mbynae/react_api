...
const Youtube = () => {
    ...
    useEffect(() => {
        ...
        fetch("https://youtube.googleapis.com/youtube/v3/search?asdasd=asd&part=snippet&q=신나는 음악&key=AIzaSyDNb11gN29B9i3IJduoczfIuN39W2env60&count=20&maxResults=20&regionCode=kr")
        .then((response) => response.json())
